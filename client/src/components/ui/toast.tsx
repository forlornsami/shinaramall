...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:top-4 sm:left-1/2 sm:-translate-x-1/2 sm:bottom-auto sm:flex-col sm:w-auto sm:min-w-[320px] md:max-w-[420px] pointer-events-none [&>*]:pointer-events-auto",
      className
    )}
    {...props}
  />
