          ...
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-white/30 text-white hover:bg-white/10 rounded-xl px-8 py-6 text-lg font-semibold backdrop-blur-sm"
                onClick={() => window.location.href = '/api/login'}
              >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-white/30 text-white hover:bg-white/10 rounded-xl px-10 py-6 text-lg font-semibold"
              onClick={() => window.location.href = '/api/login'}
            >
              Sign In
            </Button>
