        ...
        <footer className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-5 mt-4 border-t border-border/40">
          <div className="flex justify-center gap-5 mb-3">
            ...
            {storeSettings?.socialFacebook && (
              ...
              <a
              href={storeSettings?.socialFacebook || ""}
                target="_blank"
            ...
            {storeSettings?.socialInstagram && (
              ...
              <a
              href={storeSettings?.socialInstagram || ""}
                target="_blank"
                rel="noopener noreferrer"
            ...
            {/* LinkedIn */}
            {storeSettings?.socialLinkedin && (

              <a
              href={storeSettings?.socialLinkedin || ""}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
            ...
            {/* YouTube */}
            {storeSettings?.socialYoutube && (

              <a
              href={storeSettings?.socialYoutube || ""}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
