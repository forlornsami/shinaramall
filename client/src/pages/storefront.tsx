      ...
      <main className={`lg:ml-72 pt-16 lg:pt-14 min-h-screen transition-all flex flex-col ${showCartSidebar ? "lg:mr-72" : ""}`}>
        ...
        <footer className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-5 mt-4 border-t border-border/40">
          <div className="flex justify-center gap-5 mb-3">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/shinaramall"
              target="_blank"
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/shinaramall"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/shinaramall"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            ...
            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@shinaramall"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok"
            ...
            {/* YouTube */}
            <a
              href="https://www.youtube.com/@shinaramall"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
